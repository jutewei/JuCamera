...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_ROOT}/PABaseUIKit/Source/Resource/main_NavBarBack@2x.png"
  install_resource "${PODS_ROOT}/PABaseUIKit/Source/Resource/main_NavBarBack@3x.png"
  install_resource "${PODS_ROOT}/PABaseUIKit/Source/Resource/main_navBarClose@2x.png"
