...
@property(nonatomic) CGFloat currentPageSize; ///< 点的大小 默认4
...
@property(nullable, nonatomic,strong) UIImage *pageIndicatorImage NS_AVAILABLE_IOS(6_0) UI_APPEARANCE_SELECTOR;
@property(nullable, nonatomic,strong) UIImage *currentPageIndicatorImage NS_AVAILABLE_IOS(6_0) UI_APPEARANCE_SELECTOR;
@end
