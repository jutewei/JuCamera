...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    ju_imageView.juLead.equal(12);
    ju_imageView.juCenterY.equal(0);
    ju_imageView.juTop.equal(10);
    ju_imageView.juAspectWH.equal(0);


    ju_title =[[UILabel alloc]init];
    ju_title.textColor=Photo_TitleColor;
    ...
    ju_subTitle.textColor=Photo_TitleColor;
    ...
    viewLine.backgroundColor=Photo_lineColor;
...
//    [self transformAblumTitle:ju_PhotoGroup.localizedTitle];
    ...
    if (assetsFetchResults.count>0) {
        ...
        [assetsFetchResults.lastObject juRequestImageSize:CGSizeMake(80, 80) handle:^(UIImage * _Nonnull image) {
