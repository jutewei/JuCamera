...
/**
 ...
 @return 高度
 */
+(CGFloat)juGetSringHeigth:(NSString *)string maxWidth:(float)maxWidth font:(CGFloat)font;
...
/**
 ...
 @return 宽度
 */
+(CGFloat)juGetStringWidth:(NSString *)string maxWidth:(float)maxWidth font:(CGFloat)font;
...
/**
 ...
 @return 宽高
 */
+(CGSize )juGetAttributeSize:(NSString *)string maxWidth:(float)maxWidth font:(CGFloat)font lineSpace:(NSInteger)space;
